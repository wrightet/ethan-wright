        ...
        return(
            <div className='about'>
                ...
                <div >
                    ...
                    {/* <p></p> */}
                    <p>Since I was very young I have loved to make things. This started with little knick knacks I made with my mother and grandma, that led into metal/ wood working, and finally software development. I love everything programming allows me to do. Whenever I am programming It makes me feel as though I am a wizard just like in the stories I read as a child.</p>
                    <p></p>
